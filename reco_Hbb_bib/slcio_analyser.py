...
import pyLCIO # TODO: Is there a way to turn off printout of "Loading LCIO Libraries"? -Jan
import ROOT as rt
import numpy as np
    ...
    for d in daughters:
        if d.getPDG() == 22 or d.getPDG() == 23 or d.getPDG() == 24:
            if d.getEnergy() > fractional_threshold*mcp.getEnergy():
                had_hard_rad = True
                break # Jan: I don't entirely know the purpose of this func, but adding this break -- which I *think* should be here
    return had_hard_rad
...
def main(args):
    ...
    # Defining constants. TODO: Can we import this from somewhere instead?
        ...
        for ievt,event in enumerate(reader):
            ...
            for hname in hit_collection_names:
                ...
                try:
                    ...
                    if(verbose):
                        print('\tDid not find hit collection: {}. Disabling...'.frmat(hname))
                    pass
            ...
            for track in trackCollection:
                ...
                for hit in track.getTrackerHits():
                    ...
                    # now decode hits
                        ...
                        d = np.sqrt(position[0]*position[0] + position[1]
                        * position[1] + position[2]*position[2])
                        ...
                        corrected_t = hit.getTime()*(1.+rt.TRandom3(ievt).Gaus(0., resolution)) - tof
